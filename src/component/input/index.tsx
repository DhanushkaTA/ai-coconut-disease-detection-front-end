      ...
      <div id={"input-container"} className={`relative  group`}>
        <input
          ...
          className={`color w-full h-[40px] outline-none text-[14px]
                                ${props.borderRequired ? "border-2" : null} 
                                ${
                                  !props.validate
                                    ? "border-[#F03947]"
                                    : props.borderColor
        ...
        <div
          id={"icon-container"}
          className={
            "text-2xl absolute top-4 left-2 bottom-0 grayscale group-hover:grayscale-0"
          }
        >
          {props.icon}
        </div>
        {props.passBtn ? (
          <div
            className={
              " h-[40px] w-[38px] rounded-r flex justify-center items-center " +
